...
<div class="header">
	<h1>svelte-loading-spinners</h1>
	<a href="https://github.com/Schum123/svelte-loading-spinners" class="btn"> Github </a>
</div>
...
<section>
	...
	<div class="spinner-item" title="Circle2">
		<Circle2 {size} {unit} colorOuter="#FF3E00" colorCenter="#40B3FF" colorInner="#676778" />
